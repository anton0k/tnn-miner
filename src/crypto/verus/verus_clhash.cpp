...
#define TNN_VERUS_PROVIDER_ONLY 1
#if defined(TNN_VERUS_PROVIDER_ONLY)
...
#include "crypto/verus/SSE2NEON.h"
#else
#ifndef _WIN32
#include <x86intrin.h>
#endif
...
#if defined(__arm__)  || defined(__aarch64__)
/* Wave25 ARM port: modern SSE2NEON.h provides the intrinsics that were
 * historically shimmed here (_mm_aesenc_si128, _mm_clmulepi64_si128,
 * _mm_shuffle_epi8, etc.). Keeping both definitions makes overload
 * resolution ambiguous on aarch64, so the obsolete local shim is disabled.
 */
#endif 
